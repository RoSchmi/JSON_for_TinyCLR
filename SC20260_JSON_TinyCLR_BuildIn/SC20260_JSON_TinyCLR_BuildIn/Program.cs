// JSON round-trip example for TinyCLR v2
// The original application for NETMF was from M. Calsyn
// https://github.com/PervasiveDigital/jsonnetmf
//
// For TinyCLR: https://github.com/ghi-electronics/TinyCLR-Libraries/blob/dev/GHIElectronics.TinyCLR.Data.Json/JObject.cs
//
using System;
...
namespace SC20260_JSON_TinyCLR_BuildIn
{
    // Couldnet get enum working
    // See: https://docs.ghielectronics.com/software/tinyclr/tutorials/serialization.html
    ...
    public partial class Program
    {
        ...
        static void Main()
        {
            Debug.WriteLine("\r\n\r\nProgram Started, Press App Button to continue");
        ...
        private static void AppButton_ValueChanged(GpioPin sender, GpioPinValueChangedEventArgs e)
        {
            if (AppButton.Read() == GpioPinValue.Low)
            {
                ...
                {
                    Debug.WriteLine("round-tripping successful");
                }

            }
        }

        private static object CreateInstance(string path, JToken token, Type type, string name, int length)
        {
            if (name == "intArray")
