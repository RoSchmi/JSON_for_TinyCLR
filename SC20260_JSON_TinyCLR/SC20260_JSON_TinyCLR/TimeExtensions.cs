    ...
    public static class DateTimeExtensions
    {
        ...
        public static DateTime FromIso8601(string date)
        {
            ...
            if (utc)
            {
                ...
                // Changed by RoSchmi
                // dt = new DateTime(0, DateTimeKind.Utc).AddTicks(dt.Ticks);     //Original code, throws exception

                // RoSchmi: Not absolutely sure if this is correct
                dt = new DateTime(dt.Ticks, DateTimeKind.Utc);

                /* For debugging
                var minValueTicks = DateTime.MinValue.Ticks;
                var maxValueTicks = DateTime.MaxValue.Ticks;
                var thisTimeTicks = dt.Ticks;
                var minValueUtcTicks = new DateTime(minValueTicks, DateTimeKind.Utc);
                Debug.WriteLine("MinValueTicks:    " + minValueTicks.ToString());
                Debug.WriteLine("MinValueUtcTicks: " + minValueTicks.ToString());

                Debug.WriteLine("MaxValueTicks:    " + maxValueTicks.ToString());
                Debug.WriteLine("ThisTimeTicks:    " + thisTimeTicks.ToString());
                */
